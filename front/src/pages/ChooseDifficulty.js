...
const ChooseDifficulty = () => {
    ...
    return (
        <div className='choose-body'>
            <Link  style={{ marginBottom: '25px' }} className='link-game-back' to='/'> Volver Atras </Link>
            ...
            <div className='choose-buttons'>
                ...
                <div className='choose-buttons-item'>
                    ...
                    <h2>Facil</h2>
                    <p style={{ marginBottom: '20px' }}>Modo para principiantes, ideal si estas aprendiendo a jugar este complicado juego. En el modo facil la dificultad es facil, por lo que ganar será facil, por consecuencia es el modo menos dificil.</p>
                ...
                <div className='choose-buttons-item'>
                    ...
                    <h2>Medio</h2>
                    <p style={{ marginBottom: '20px' }}>Modo para personas mas experimentadas, se podria decir que un mid level o nivel medio es alguien que es promedio, para llegar a este nivel requieres de al menos 15 años de entrenamiento.</p>
                ...
                <div className='choose-buttons-item'>
                    ...
                    <h2>Dificil</h2>
                    <p style={{ marginBottom: '20px' }}>Para poder jugar en este modo debes ser una computadora o un chino (o sea lo mismo), con esta dificultad deberas prepararte para ser brutalmente humillado por un conjuntos de ceros y unos.</p>
