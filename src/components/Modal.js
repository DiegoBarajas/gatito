            ...
            <div className="hoja">
                <div className='content-hoja'>
                    ...
                    <div style={{ display: 'flex', justifyContent: 'space-around', alignItems: 'center', marginTop: '20px', }}>
                        <Button color='blue' style={{ padding: '5px 20px 5px 20px' }} onClick={onAccept}>{acceptText}</Button>
                        {
                            cancelText === '' ? <></> : <Button color='red' style={{ padding: '5px 20px 5px 20px' }} onClick={onCancel}>{cancelText}</Button>
                        }
